...
const slide001 = new URL('../public/slide-001.png', import.meta.url);
const slide002 = new URL('../public/slide-002.png', import.meta.url);
const slide003 = new URL('../public/slide-003.png', import.meta.url);
const slide004 = new URL('../public/slide-004.png', import.meta.url);
const slide005 = new URL('../public/slide-005.png', import.meta.url);
...
writeIcon(slide001, 1280, 720, [0x18, 0x22, 0x38, 0xff], patterned([0x18,0x22,0x38,0xff]));
writeIcon(slide002, 1280, 720, [0x22, 0x28, 0x3c, 0xff], patterned([0x22,0x28,0x3c,0xff]));
writeIcon(slide003, 1280, 720, [0x2a, 0x30, 0x48, 0xff], patterned([0x2a,0x30,0x48,0xff]));
writeIcon(slide004, 1280, 720, [0x12, 0x16, 0x24, 0xff], patterned([0x12,0x16,0x24,0xff]));
writeIcon(slide005, 1280, 720, [0x10, 0x1a, 0x30, 0xff], patterned([0x10,0x1a,0x30,0xff]));
